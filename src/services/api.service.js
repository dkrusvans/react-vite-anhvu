...
const createUserAPI=(fullName,email,passWords,phoneNumber)=>{
...
const registerUserAPI=(fullName,email,passWords,phoneNumber)=>{
...
const loginAPI=(email, passWords)=>{
...
export {
    ...
    updateUserAvatarAPI, registerUserAPI, loginAPI,
